...
export const footerStyles = {
  ...
  josmartContainer: "relative mr-3",
  josmart: "w-6 h-6 bg-emerald-500 rounded-sm transform rotate-45",
  josmartInner: "absolute inset-0 flex items-center justify-center",
  josmartInnerShape: "w-3 h-3 bg-white transform -rotate-45",
